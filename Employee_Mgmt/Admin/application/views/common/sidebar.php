        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="<?php echo base_url('AddCompany'); ?>" class="nav-link">
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="<?php echo base_url('EmployeeList'); ?>" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Employee List</p>
                </a>
              </li>
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="<?php echo base_url('EmployeePayrollList'); ?>" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Employee Payroll List</p>
                </a>
              </li>
          ...
          <li class="nav-item has-treeview">
            <a href="<?php echo base_url('Holiday'); ?>" class="nav-link">
               <i class="nav-icon fas fa-copy"></i>
              <p>
                Holidays
